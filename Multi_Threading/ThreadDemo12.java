...
class DemoEven extends Thread
{
    ...
    public DemoEven(Data obj)    //parametrised constructor
    {
        dobj = obj;
    }
...
class ThreadDemo12
{
    public static void main(String a[]) throws InterruptedException
    {
        ...
        DemoEven eobj = new DemoEven(obj1);   //composition
        DemoOdd oobj = new DemoOdd(obj1);     //composition

        Thread t1 = new Thread(eobj);   //composition
        Thread t2 = new Thread(oobj);   //composition
